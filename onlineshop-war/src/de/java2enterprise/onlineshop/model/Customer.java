...
public class Customer implements Serializable {
	...
	public Item addOffer(Item offer) {
		List<Item> lOffers = getOffers();
		if (lOffers == null) {
			lOffers = new ArrayList<Item>();
		}
		lOffers.add(offer);
	...
	public Item addPurchas(Item purchase) {
		List<Item> lPurchases = getPurchases();
		if (lPurchases == null) {
			lPurchases = new ArrayList<Item>();
		}
		lPurchases.add(purchase);
